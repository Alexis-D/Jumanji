...
Shortcut shortcuts[] = {
  ...
  {GDK_CONTROL_MASK,   GDK_twosuperior,   sc_abort,             ALL,          { 0,                  NULL } },
  ...
  {0,                  GDK_asterisk,      sc_search_selected,   NORMAL,       { FORWARD,            NULL } },
  {0,                  GDK_numbersign,    sc_search_selected,   NORMAL,       { BACKWARD,           NULL } },
